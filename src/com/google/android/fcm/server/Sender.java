...
import static com.google.android.fcm.server.Constants.FCM_SEND_ENDPOINT;
import static com.google.android.fcm.server.Constants.JSON_RESULTS;
import static com.google.android.fcm.server.Constants.JSON_RESULTS_ERROR;
import static com.google.android.fcm.server.Constants.JSON_RESULTS_MESSAGE_ID;
import static com.google.android.fcm.server.Constants.JSON_RESULTS_REGISTRATION_ID;
import static com.google.android.fcm.server.Constants.PARAM_COLLAPSE_KEY;
import static com.google.android.fcm.server.Constants.PARAM_DATA_PAYLOAD;
import static com.google.android.fcm.server.Constants.PARAM_NOTIFICATION_PAYLOAD;
import static com.google.android.fcm.server.Constants.PARAM_SEND_TO;
import static com.google.android.fcm.server.Constants.PARAM_TIME_TO_LIVE;
...
import com.google.android.fcm.server.Response.Builder;
  ...
  public Response sendNoRetry(Message message, String registrationId) throws Exception {
    ...
    try {
      ...
      try {
        ...
        if (value!=null) {
          Builder builder = new Response.Builder().messageId(value);
